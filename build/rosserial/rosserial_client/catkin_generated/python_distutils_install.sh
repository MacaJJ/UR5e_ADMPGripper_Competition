...
echo_and_run cd "/home/justin/RoboSoft2023arm_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/justin/RoboSoft2023arm_ws/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/justin/RoboSoft2023arm_ws/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
