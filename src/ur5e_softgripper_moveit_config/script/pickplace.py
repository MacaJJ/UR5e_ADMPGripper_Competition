					...
					for detected_obj in self.tp.detected_obj_pose_list: 
						if detected_obj.results.Class == obj:
							...
							for pose in plate_list:
								...
								elif obj == 'cookies' or obj == 'iced_gems' or obj == 'carrot_slice' or obj == 'bottle':
				...
				while place_count[obj] < pick_count[obj]:
					for detected_obj in self.tp.detected_obj_pose_list: 
						if detected_obj.results.Class == obj:
							...
							# elif obj == 'Green_Beans' or obj == 'Sausage' or obj == 'noodles':
...
if __name__ == '__main__':
	...
	pickplace_object.MoveToJoint(location_5)

	#Test pick
	pick_count_1 = {'Green_Beans': 1}
	pick_count_2 = {'noodles': 1}
	pick_count_3 = {'carrot_slice': 1} #Cookie mistaken as carrot_slice
	...
	# #Actual pick
	# pick_count_1 = {'Green_Beans': 2}
	# pick_count_2 = {'noodles': 1}
	# pick_count_3 = {'bottle': 3} #Cookie mistaken as bottle
	# pick_count_4 = {'fried_eggs': 2} 

	# pick_count_5 = {'broccoli': 5}
	# pick_count_6 = {'carrot': 5}
	# pick_count_7 = {'broccoli': 3}

	yellow_place_count_1 = {'Green_Beans': 0}
	yellow_place_count_2 = {'noodles': 0}
	yellow_place_count_3 = {'carrot_slice': 0} #Cookie mistaken as bottle
	...
	green_place_count_3 = {'cookies': 0} #Cookie mistaken as bottle
