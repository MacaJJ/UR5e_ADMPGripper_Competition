...
class PickPlace:
	...
	def SourceTable_Object_Low(self, obj, orientation):
		...
		if orientation == 'Parallel':
			...
			perp_orientation = quaternion_from_euler(pi,0,0)
				...
				while place_count[obj] < pick_count[obj]:
					for detected_obj in self.tp.detected_obj_pose_list: 
						if detected_obj.results.Class == obj:
							...
							elif obj == 'Green_Beans' or obj == 'Sausage' or obj == 'bottle':
...
if __name__ == '__main__':
	...
	pick_count_5 = {'bottle': 1}
	yellow_place_count_5 = {'bottle': 0}

	pickplace_object,PnP_Location_Low(yellow_plate_container_pose_list, pick_count_5, yellow_place_count_5, location_5)
